...
namespace KryneEngine::Modules::RenderGraph
{
    ...
    PassAttachmentDeclarationBuilder PassDeclarationBuilder::SetDepthAttachment(SimplePoolHandle _texture)
    {
        ...
        m_item.m_depthAttachment.value().m_stencilLoadOperation = RenderPassDesc::Attachment::LoadOperation::None;
        m_item.m_depthAttachment.value().m_stencilStoreOperation = RenderPassDesc::Attachment::StoreOperation::None;
